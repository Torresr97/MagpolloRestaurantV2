    ...
    public partial class Efectivovista : Form
    {
        ...
        private void txtdinerorecibido_TextChanged(object sender, EventArgs e)
        {
            if (txtdinerorecibido.Text == "")
            {
                ...
                Globales.Dinerorecibido = Convert.ToDecimal(txtdinerorecibido.Text);
                txtvuelto.Text = "0";
            }
            else
            {
                if (Convert.ToInt64(txtdinerorecibido.Text) < Convert.ToInt64(txtventatotal.Text))
                {
                ...
                else
                {
                    ...
                    Globales.Dinerorecibido = Convert.ToDecimal(txtdinerorecibido.Text);
                    txtvuelto.Text = (Globales.ventatotal - Globales.Dinerorecibido).ToString().Replace("-", "");
                    Globales.vuelto = Convert.ToDecimal(txtvuelto.Text);
                }
            }
        }
        ...
        private void btncobrar_Click_1(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(txtdinerorecibido.Text) < Convert.ToInt32(txtventatotal.Text))
            {
